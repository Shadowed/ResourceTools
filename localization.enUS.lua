ResourceToolsLocals = {
	...
	["%s is using %s memory."] = "%s is using %s memory.",
	["%.2f MB"] = "%.2f MB",
	["%.2f KB"] = "%.2f KB",
	...
	["All Events: %.3f seconds, called %d"] = "All Events: %.3f seconds, called %d",
	...
	["%s (subroutines %s) took %.3f seconds, called %d times."] = "%s (subroutines %s) took %.3f seconds, called %d times.",
